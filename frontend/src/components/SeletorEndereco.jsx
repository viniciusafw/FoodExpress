...
export default function AddressSelector({ onClick }) {
  ...
  return (
    <button type="button" onClick={abrirSeletor} className="flex items-center gap-3 px-6 py-4 bg-white rounded-2xl cursor-pointer shadow-lg transition-all border border-transparent min-w-70 font-medium hover:-translate-y-px hover:shadow-xl hover:border-primary group">
